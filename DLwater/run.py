...
# data loader
parser.add_argument('--data', type=str, default='customB', help='dataset type')
parser.add_argument('--root_path', type=str, default='./dataset', help='root path of the data file')
parser.add_argument('--data_path', type=str, default='burnett-river-completed.csv', help='data file')
...
parser.add_argument('--cycle_len', type=int, nargs='+', default=[24,168,720], help='cycle length(s) for MDM')
